...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reg_player', 'city', self.gf('django.db.models.fields.CharField')(default='Mumbai', max_length=50), keep_default=False)

        # Adding field 'Player.pincode'
        db.add_column('reg_player', 'pincode', self.gf('django.db.models.fields.IntegerField')(default=573201), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.city'
        db.delete_column('reg_player', 'city')

        # Deleting field 'Player.pincode'
        db.delete_column('reg_player', 'pincode')
