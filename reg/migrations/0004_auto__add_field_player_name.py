...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reg_player', 'name', self.gf('django.db.models.fields.CharField')(default='Abcd', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.name'
        db.delete_column('reg_player', 'name')
