...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reg_team', 'city', self.gf('django.db.models.fields.CharField')(default='Mumbai', max_length=50), keep_default=False)

        # Adding field 'Team.pincode'
        db.add_column('reg_team', 'pincode', self.gf('django.db.models.fields.IntegerField')(default=573201), keep_default=False)

        # Removing M2M table for field team_status on 'Team'
        db.delete_table('reg_team_team_status')

        # Changing field 'Team.status'
        db.alter_column('reg_team', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    def backwards(self, orm):
        ...
        db.delete_column('reg_team', 'city')

        # Deleting field 'Team.pincode'
        db.delete_column('reg_team', 'pincode')
        ...
        # Changing field 'Team.status'
        db.alter_column('reg_team', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        'reg.team': {
            ...
            'pincode': ('django.db.models.fields.IntegerField', [], {}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
